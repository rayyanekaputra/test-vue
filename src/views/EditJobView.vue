...
const handleSubmit = async () => {
    ...
    try {
        ...
        toast.success('Failed to edit job')
...
onMounted(async() => {
    try {
        ...
        console.error('Erro fetching job before edit', error)
    } finally {
            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent = "handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name"  v-model="form.title" name="name" class="border rounded w-full py-2 px-3 mb-2"
                            placeholder="eg. Beautiful Apartment In Miami" required />
                    </div>
                    <div class="mb-4">
                        <label for="description" class="block text-gray-700 font-bold mb-2">Description</label>
                        <textarea id="description" name="description"  v-model="form.description" class="border rounded w-full py-2 px-3" rows="4"
                            placeholder="Edit any job duties, expectations, requirements, etc"></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="company"  v-model="form.company.name" name="company" class="border rounded w-full py-2 px-3"
